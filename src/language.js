export const language = {
    ARM: {
        ...
        homeRecommendedCollection: [
            {  id: 1, image: '/shackleton-leather-sofa.png', name: 'Shackleton կաշվե բազմոց', price: '869,500 դրամ', type: 'Ուղիղ չորստեղանոց բազմոց', style: 'Լոֆթ / Անգլիական դասական ոճ', design: 'Chesterfield դասական ուրվագիծ՝ խորը կարետային կարումով', color: 'Վինտաժ շագանակագույն / Հնեցված կաշի', peculiarities: 'Մեծ կլորացված բազկակալներ, դեկորատիվ մեխիկներով եզրագծում և բնական փայտից ոտքեր' },
            {  id: 2, image: '/upton-chesterfield-sofa.png', name: 'Upton Chesterfield բազմոց', price: '399,500 դրամ', type: 'Ուղիղ երեքտեղանոց բազմոց', style: 'Նեոկլասիկա / Անգլիական ոճ', design: 'Դասական կարետային կարում կլորացված բազկակալներով', color: 'Ծովային ալիք / Մեղմ փիրուզագույն', peculiarities: 'Ցածր թիկնակ, որը միանում է բազկակալներին, և փորագրված փայտե սոխաձև ոտքեր' },
            {  id: 3, image: '/lana-double-bed.png', name: 'Lana երկտեղանի մահճակալ', price: '211,500 դրամ', type: 'Փափուկ մահճակալ բարձրացվող մեխանիզմով', style: 'Մինիմալիզմ / Ժամանակակից ոճ', design: 'Ուղղահայաց կարում գլխամասի և ոտնամասի վրա', color: 'Գրաֆիտ / Մուգ մոխրագույն վելյուր', peculiarities: 'Փափուկ զանգվածային հիմք, թաքնված ոտքեր և խորը կտորի տեքստուրա' },
            {  id: 4, image: '/marlborough-armchair.png', name: 'Marlborough բազկաթոռ', price: '164,500 դրամ', type: 'Լայն փափուկ բազկաթոռ', style: 'Սկանդինավյան հարմարավետություն / Կոնտեմպորարի', design: 'Մեծ չափերի կառուցվածք՝ փափուկ բարձիկային բազկակալներով', color: 'Մուգ մելանժ / Գրաֆիտային թվիդ', peculiarities: 'Խորը նստատեղ, արտահայտված գործվածքի կառուցվածք և լրացուցիչ կողային բարձիկներ՝ ավելի մեծ հարմարավետության համար' },
            {  id: 5, image: '/mirrored-cabinet.png', name: 'Հայելիով պատված պահարան', price: '599,300 դրամ', type: "Ազատ կամ ներկառուցված զգեստապահարան", style: "Ժամանակակից դասական", design: "Հինգ դռնանի մոդուլային համակարգ", color:	"Անտրացիտ / Մատ գրաֆիտ", peculiarities:	"Ճակատներ բարակ շրջանակներով և լիարժեք հայելիներով" },
            {  id: 6, image: '/velvet-storage-bench.png', name: 'Պահոցով փափուկ բանկետկա', price: '56,400 դրամ', type: 'Փափուկ բանկետկա / Պահեստային սնդուկ', style: 'Նեոկլասիկա / Արտ-դեկո', design: 'Ուղղանկյուն հիմք՝ բարձրացվող կափարիչով և կարետային կարումով', color: 'Արծաթամոխրագույն / Ծխագույն վելյուր', peculiarities: 'ԿՆստատեղն ունի փափուկ, կարված պաստառագործություն՝ թաքնված պահեստային բաժանմունքով և փափուկ, փայլուն թավշյա պաստառագործությամբ' }
        ],
    ...
    RUS: {
        ...
        homeRecommendedCollection: [
            {  id: 1, image: '/shackleton-leather-sofa.png', name: 'Кожаный диван Shackleton', price: '185,000 рублей', type: 'Четырехместный прямой диван', style: 'Лофт / Английская классика', design: 'Классический силуэт Честерфилд с глубокой каретной стяжкой', color: 'Винтажный коричневый / Состаренная кожа', peculiarities: 'Массивные закругленные подлокотники, отделка декоративными гвоздиками и ножки из натурального дерева' },
            {  id: 2, image: '/upton-chesterfield-sofa.png', name: 'Диван Честерфилд Upton', price: '85,000 рублей', type: 'Прямой трехместный диван', style: 'Неоклассика / Английский стиль', design: 'Классическая каретная стяжка с закругленными подлокотниками', color: 'Морская волна / Приглушенный бирюзовый', peculiarities: 'Низкая спинка, переходящая в подлокотники, и резные деревянные ножки в форме луковицы' },
            {  id: 3, image: '/lana-double-bed.png', name: 'Двуспальная кровать Lana', price: '45,000 рублей', type: 'Мягкая кровать с подъемным механизмом', style: 'Минимализм / Современный стиль', design: 'Вертикальная стяжка на изголовье и изножье', color: 'Графит / Темно-серый велюр', peculiarities: 'Массивное мягкое основание, скрытые ножки и глубокая фактура ткани' },
            {  id: 4, image: '/marlborough-armchair.png', name: 'Интерьерное кресло Marlborough', price: '35,000 рублей', type: 'Широкое мягкое кресло', style: 'Скандинавский уют / Контемпорари', design: 'Массивный корпус с мягкими подушками-подлокотниками', color: 'Темный меланж / Графитовый твид', peculiarities: 'Глубокая посадка, фактурная рогожка и дополнительные боковые подушки для комфорта' },
            {  id: 5, image: '/mirrored-cabinet.png', name: 'Зеркальный шкаф', price: '130,000 рублей', type: "Отдельно стоящий или встроенный шкаф", style: "Современная классика", design: "Пятидверная модульная система", color: "Антрацит / Матовый графит", peculiarities: "Фасады с тонкими рамками и полноростовыми зеркалами" },
            {  id: 6, image: '/velvet-storage-bench.png', name: 'Банкетка-пуф с ящиком для хранения', price: '12,000 рублей', type: 'Мягкая банкетка / Сундук для хранения', style: 'Неоклассика / Ар-деко', design: 'Прямоугольное основание с откидной крышкой и каретной стяжкой', color: 'Серебристо-серый / Дымчатый велюр', peculiarities: 'Сиденье имеет мягкую стеганую обивку со скрытым отделением для хранения и мягкую блестящую велюровую обивку' }
        ],
    ...
    ENG: {
        ...
        homeRecommendedCollection: [
            { id: 1, image: '/shackleton-leather-sofa.png', name: 'Shackleton Leather Sofa', price: '2,291 US dollars', type: 'Four-seater straight sofa', style: 'Loft / English classic', design: 'Classic Chesterfield silhouette with deep button tufting', color: 'Vintage brown / Aged leather', peculiarities: 'Massive rounded armrests, decorative nailhead trim, and solid wood legs' },
            { id: 2, image: '/upton-chesterfield-sofa.png', 'name': 'Upton Chesterfield Sofa', 'price': '1,052 US dollars', 'type': 'Straight three-seater sofa', 'style': 'Neoclassical / English style', 'design': 'Classic button tufting with rounded armrests', 'color': 'Sea wave / Muted turquoise', 'peculiarities': 'Low back flowing into the armrests and carved wooden bun-shaped legs' },
            { id: 3, image: '/lana-double-bed.png', name: 'Lana Double Bed', price: '557 US dollars', type: 'Upholstered bed with lifting mechanism', style: 'Minimalism / Modern style', design: 'Vertical tufting on the headboard and footboard', color: 'Graphite / Dark gray velour', peculiarities: 'Massive soft base, hidden legs, and deep fabric texture' },
            { id: 4, image: '/marlborough-armchair.png', name: 'Marlborough Armchair', price: '433 US dollars', type: 'Wide upholstered armchair', style: 'Scandinavian comfort / Contemporary', design: 'Massive body with soft armrest cushions', color: 'Dark melange / Graphite tweed', peculiarities: 'Deep seating, textured fabric weave, and additional side cushions for extra comfort' },
            { id: 5, image: '/mirrored-cabinet.png', name: 'Mirrored cabinet', price: '1,580 US dollars', type: "Freestanding or built-in wardrobe", style: "Modern classic", design:	"Five-door modular system", color: "Anthracite / Matte graphite", peculiarities: "Facades with thin frames and full-height mirrors" },
            { id: 6, image: '/velvet-storage-bench.png', name: 'Velvet Storage Bench', price: '148 US dollars', type: 'Upholstered bench / Storage chest', style: 'Neoclassical / Art Deco', design: 'Rectangular base with a lift-up lid and button tufting', color: 'Silvery gray / Smoky velour', peculiarities: 'The seat features a soft, quilted seat with a hidden storage compartment and soft, sheen velour upholstery' }
        ],
